        ...
        <body style="margin: 0; padding: 0; font-family: 'Inter', sans-serif;">
            ...
            <main class="dashboard-container">
                <div style="max-width: 900px; margin: 0 auto; width: 100%;">
                    <div
                        style="background: var(--card); border-radius: var(--radius); box-shadow: var(--shadow-lg); overflow: hidden;">
                        <!-- Chat Header -->
                        <div
                            style="background: var(--primary); color: var(--primary-foreground); padding: 1.5rem; border-bottom: 1px solid var(--border);">
                        ...
                        <div id="messagesContainer"
                            style="height: 500px; overflow-y: auto; padding: 1.5rem; background: var(--background);">
                            <c:forEach var="message" items="${messages}">
                                <div
                                    style="margin-bottom: 1rem; display: flex; ${message.senderId == sessionScope.currentUser.userId ? 'justify-content: flex-end' : 'justify-content: flex-start'};">
                                    <div
                                        style="max-width: 70%; ${message.senderId == sessionScope.currentUser.userId ? 'background: var(--primary); color: var(--primary-foreground);' : 'background: var(--card); color: var(--foreground); border: 1px solid var(--border);'} padding: 0.75rem 1rem; border-radius: 1rem;">
                        ...
                        <div style="padding: 1.5rem; border-top: 1px solid var(--border); background: var(--card);">
                            <form method="post" action="${pageContext.request.contextPath}/chats/send"
                                ...
                                <button type="submit"
                                    style="background: var(--primary); color: var(--primary-foreground); padding: 0.75rem 1.5rem; border: none; border-radius: 9999px; font-weight: 600; cursor: pointer;">
                                    Send
                                </button>
                            </form>
                        </div>
                    ...
                    <div style="text-align: center; margin-top: 1rem;">
                        <a href="${pageContext.request.contextPath}/chats"
