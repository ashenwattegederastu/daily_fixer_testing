...
<%--    <h3><fmt:message key="sidebar.navigation"/></h3>--%>
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/userdash/myProfile.jsp" class="active"><fmt:message key="user.my_profile"/></a></li>
    </ul>
...
<main class="container">
    <h2><fmt:message key="user.my_profile"/></h2>
