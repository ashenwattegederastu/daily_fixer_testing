...
<%--    <h3><fmt:message key="sidebar.navigation"/></h3>--%>
    <ul>
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/userdash/userdashmain.jsp"><fmt:message key="user.dashboard"/></a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/userdash/myBookings.jsp" class="active"><fmt:message key="user.my_bookings"/></a></li>
...
<main class="container">
    <h2><fmt:message key="user.bookings.title"/></h2>
    ...
    <div class="booking-table">
        <table>
            <thead>
                <tr>
                    <th><fmt:message key="user.bookings.service"/></th>
                    <th><fmt:message key="user.bookings.technician"/></th>
                    <th>Date & Time</th>
                    <th>Address</th>
                    <th><fmt:message key="user.bookings.status"/></th>
                    <th><fmt:message key="user.bookings.actions"/></th>
                </tr>
            </thead>
            <tbody>
                <tr>
