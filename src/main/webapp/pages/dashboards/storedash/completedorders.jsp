...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/storedash/completedorders.jsp" class="active"><fmt:message key="store.completed_orders"/></a></li>
...
<main class="container">
    <h2><fmt:message key="store.orders.completed_title"/></h2>
