...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/storedash/orders.jsp" class="active"><fmt:message key="store.orders"/></a></li>
...
<main class="container">
    <h2><fmt:message key="store.orders.title"/></h2>
    
    <table>
        <thead>
            <tr>
                <th><fmt:message key="store.orders.id"/></th>
                <th><fmt:message key="store.orders.customer"/></th>
                <th><fmt:message key="store.orders.date"/></th>
                <th><fmt:message key="store.orders.status"/></th>
                <th><fmt:message key="store.orders.total"/></th>
                <th>Action</th>
            </tr>
        </thead>
        <tbody>
