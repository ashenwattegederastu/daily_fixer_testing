...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/storedash/myProfile.jsp" class="active"><fmt:message key="store.profile"/></a></li>
    </ul>
...
<main class="container">
    <h2><fmt:message key="store.profile"/></h2>
