<%@ taglib uri="jakarta.tags.core" prefix="c" %>
    <%@ page import="com.dailyfixer.model.User" %>
        ...
        <% User currentUser=(User) session.getAttribute("currentUser"); String firstName=currentUser !=null &&
            ...
            <!-- Note: Since dark-mode.js is included in the individual pages usually, we don't strictly need it here if it's already in the main jsp. But keeping script helps isolation. -->
