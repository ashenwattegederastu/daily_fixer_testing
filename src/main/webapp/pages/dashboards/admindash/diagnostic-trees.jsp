            ...
            <% User user=(User) session.getAttribute("currentUser"); if (user==null || user.getRole()==null ||
                ...
                <body class="dashboard-layout">
                    ...
                    <aside class="sidebar">
                        ...
                        <ul>
                            <li><a
                                    href="${pageContext.request.contextPath}/pages/dashboards/admindash/admindashmain.jsp"><fmt:message key="admin.dashboard"/></a></li>
                            <li><a href="${pageContext.request.contextPath}/admin/users"><fmt:message key="admin.user_management"/></a></li>
                            <li><a
                                    href="${pageContext.request.contextPath}/pages/dashboards/admindash/flags.jsp"><fmt:message key="admin.flags"/></a></li>
                            <li><a
                                    href="${pageContext.request.contextPath}/pages/dashboards/admindash/transactions.jsp"><fmt:message key="admin.transactions"/></a></li>
                            ...
                            <li><a href="${pageContext.request.contextPath}/pages/dashboards/admindash/diagnostic-trees.jsp"
                                    class="active"><fmt:message key="admin.diagnostic_trees"/></a></li>
                        </ul>
       ...
       <fmt:message key="nav.lang_switch"/>
                    ...
                    <main class="main-content">
                        <div class="page-header">
                            <h1><fmt:message key="admin.diagnostic_trees"/></h1>
