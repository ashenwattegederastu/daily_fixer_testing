...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/admindash/flags.jsp"><fmt:message key="admin.flags"/></a></li>
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/admindash/transactions.jsp" class="active"><fmt:message key="admin.transactions"/></a></li>
    </ul>
...
<main class="main-content">
    <div class="dashboard-header">
        <h1><fmt:message key="admin.transactions.title"/></h1>
    ...
    <div class="section">
        ...
        <div class="table-container">
            <table>
                <thead>
                    <tr>
                        <th><fmt:message key="admin.transactions.id"/></th>
                        <th><fmt:message key="admin.transactions.user"/></th>
                        <th>Type</th>
                        <th><fmt:message key="admin.transactions.amount"/></th>
<%--                        <th>Status</th>--%>
                        <th><fmt:message key="admin.transactions.date"/></th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
