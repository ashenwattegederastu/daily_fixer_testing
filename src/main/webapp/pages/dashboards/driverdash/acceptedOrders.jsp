...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/driverdash/acceptedOrders.jsp" class="active"><fmt:message key="driver.accepted_orders"/></a></li>
...
<main class="container">
    <h2><fmt:message key="driver.accepted.title"/></h2>
    
    <table>
        <thead>
            <tr>
                <th><fmt:message key="driver.orders.id"/></th>
                <th><fmt:message key="driver.orders.customer"/></th>
                <th>Pickup Location</th>
                <th>Delivery Location</th>
                <th>Status</th>
                <th>Accepted Time</th>
                <th><fmt:message key="driver.orders.actions"/></th>
            </tr>
        </thead>
        <tbody>
            <tr>
