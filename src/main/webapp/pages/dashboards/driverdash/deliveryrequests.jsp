...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/driverdash/deliveryrequests.jsp" class="active"><fmt:message key="driver.delivery_requests"/></a></li>
...
<main class="container">
    <h2><fmt:message key="driver.orders.title"/></h2>
