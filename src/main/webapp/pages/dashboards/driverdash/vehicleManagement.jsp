...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/driverdash/vehicleManagement.jsp" class="active"><fmt:message key="driver.vehicle_management"/></a></li>
...
<main class="container">
    <h2><fmt:message key="driver.vehicle.title"/></h2>
