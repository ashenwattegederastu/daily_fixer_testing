...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/driverdash/completedOrders.jsp" class="active"><fmt:message key="driver.completed_orders"/></a></li>
...
<main class="container">
    <h2><fmt:message key="driver.completed.title"/></h2>
