...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/techniciandash/acceptedBookings.jsp" class="active"><fmt:message key="tech.accepted_bookings"/></a></li>
...
<main class="container">
    <h2><fmt:message key="tech.accepted_bookings"/></h2>
