...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/techniciandash/completedBookings.jsp" class="active"><fmt:message key="tech.completed_bookings"/></a></li>
...
<main class="container">
    <h2><fmt:message key="tech.completed_bookings"/></h2>
