...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/pages/dashboards/techniciandash/myProfile.jsp" class="active"><fmt:message key="tech.my_profile"/></a></li>
    </ul>
...
<main class="container">
    <h2><fmt:message key="tech.my_profile"/></h2>
