    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (reason == null || reason.trim().isEmpty()) {
                out.write("{\"success\": false, \"message\": \"Rejection reason is required\"}");
                return;
            }
            ...
            if (booking.getStatus() != Booking.BookingStatus.REQUESTED) {
                out.write("{\"success\": false, \"message\": \"Booking cannot be rejected\"}");
                return;
            }

            bookingDAO.updateBookingStatus(bookingId, Booking.BookingStatus.REJECTED);

            out.write("{\"success\": true, \"message\": \"Booking rejected\"}");
